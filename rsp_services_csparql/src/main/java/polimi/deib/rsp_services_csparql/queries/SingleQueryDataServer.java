...
public class SingleQueryDataServer extends ServerResource {
	...
	public void registerQuery(Representation rep){
		...
		try{
			...
			String contentType = getRequest().getEntity().getMediaType().toString();
			...
			System.out.println(parameterQueryName + " registering...");
...
//						}
	...
	public void changeQueryStatus(Representation rep){
		...
		try{
			...
			System.out.println("--------Changing query status(adding an observer)-----------");
			String contentType = getRequest().getEntity().getMediaType().toString();
			System.out.println("content type: " + contentType);
			String callbackUrl = "";
			String streamName = "";
			...
			if(contentType.startsWith("application")){
				...
				streamName = form.getValues("streamname");
				System.out.println("stream name: " + streamName);
			}else{
				callbackUrl = rep.getText();
				System.out.println("callback URL: " + callbackUrl);
			}
