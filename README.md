...
All three components are lightweight maven projects. All can be run from eclipse or from a jar file. Jar can be generated with mvn package, which creates a target folder with a jar file inside.  
